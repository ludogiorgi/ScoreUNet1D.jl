# ==============================================================================
# Run Pipeline L96: Iterative Train-Integrate-Plot Pipeline
# ==============================================================================
#
# This script:
#   1. Trains score network (continuing from previous if exists)
#   2. Creates timestamped run folder
#   3. Saves NN and loss plot to run folder and scripts/L96/
...
#
# Usage:
#   nohup julia --project=. scripts/L96/run_pipeline_l96.jl > scripts/L96/pipeline.log 2>&1 &
#
# ==============================================================================
...
run_root = joinpath(PROJECT_ROOT, get(pipeline, "run_root", "runs/L96"))
model_path_scripts = joinpath(PROJECT_ROOT, get(pipeline, "model_path", "scripts/L96/trained_model.bson"))
...
for iter in 1:n_iterations
    ...
    # Save/update model in scripts/L96 (for next iteration)
