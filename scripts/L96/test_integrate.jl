# ==============================================================================
# test_integrate_l96.jl: Self-contained Langevin integration for L96
# ==============================================================================
...
phi_sigma_path = joinpath(PROJECT_ROOT, get(phi_sigma_cfg, "path", "scripts/L96/phi_sigma.hdf5"))
